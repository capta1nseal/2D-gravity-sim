...
void SimulationApplication::initializeSdl()
{
...
void SimulationApplication::initializeInput()
{
    input.setKeyboardState(keyboardState);
}

void SimulationApplication::initializeCamera()
{
...
void SimulationApplication::tick(double delta)
{
    attractorArray.tick();
...
void SimulationApplication::clearWindowTexture()
{
...
void SimulationApplication::draw()
{
    SDL_SetRenderTarget(renderer, windowTexture);
...
void SimulationApplication::deInitializeSdl()
{
